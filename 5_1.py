...
lex = pd.read_csv('/Users/krishna/Downloads/subjectivity_clues_hltemnlp05/subjclueslen1-HLTEMNLP05.csv', engine='python', usecols=fields, delim_whitespace=True)
...
def task1(train_data, test_data, target):
    ...
    output = 'lex_train_'+target[:3]+'.csv'
